    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "codename",
                    models.CharField(
                        help_text="Ej: 'view_global_stats'", max_length=100, unique=True
                    ),
                ),
                (
                    "domain",
                    models.CharField(
                        help_text="Dominio sistémico (ej: comercial, contable, operativa)",
                        max_length=100,
                    ),
                ),
                (
                    "module",
                    models.CharField(
                        help_text="Módulo específico (ej: billing, inventory)",
                        max_length=100,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "is_system_role",
                    models.BooleanField(
                        default=False, help_text="Si es true, no puede ser eliminado."
                    ),
                ),
                (
                    "authority_level",
                    models.IntegerField(
                        default=1,
                        help_text="Nivel jerárquico (1: Operativo, 2: Delegado, 3: Soberano)",
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.TextField(
                        blank=True,
                        help_text="Respuesta del prestador a la reseña.",
                        null=True,
                    ),
                ),
                ("fecha_creacion", models.DateTimeField(auto_now_add=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "radius",
                    models.IntegerField(help_text="Radio de detección en metros"),
                ),
                ("is_active", models.BooleanField(default=True)),
                ("created_at", models.DateTimeField(auto_now_add=True)),
            ],
