...
REST_AUTH = {
    "USE_JWT": True,
    "JWT_AUTH_COOKIE": "sarita-auth",
    "JWT_AUTH_REFRESH_COOKIE": "sarita-refresh",
...
# SIMPLE JWT CONFIGURATION (RS256)
...
SIMPLE_JWT = {
    ...
    "ALGORITHM": "RS256",
    "SIGNING_KEY": open(BASE_DIR / "keys" / "jwt-private.pem").read(),
    "VERIFYING_KEY": open(BASE_DIR / "keys" / "jwt-public.pem").read(),
