...
# Modelos locales
from apps.prestadores.mi_negocio.gestion_operativa.modulos_genericos.clientes.models import Proveedor, FacturaCompra
...
class FacturaCompraAdminViewSet(viewsets.ModelViewSet):
