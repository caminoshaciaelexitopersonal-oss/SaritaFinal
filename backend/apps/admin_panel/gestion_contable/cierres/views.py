...
from apps.prestadores.mi_negocio.gestion_operativa.modulos_genericos.clientes.models import PeriodoContable
from .serializers import PeriodoContableSerializer
from .services import CierreContableService

class PeriodoContableAdminViewSet(viewsets.ModelViewSet):
