...
from apps.prestadores.mi_negocio.gestion_operativa.modulos_genericos.clientes.models import Valoracion
...
class ValoracionAdminViewSet(viewsets.ModelViewSet):
    """
