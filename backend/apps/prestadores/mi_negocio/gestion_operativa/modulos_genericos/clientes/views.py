...
# --- Contenido deshabilitado temporalmente para permitir el arranque del servidor ---
# La funcionalidad de Clientes (CRM) será restaurada una vez que el modelo
# 'Cliente' y su serializador estén completamente implementados en la app 'comercial'.
"""
