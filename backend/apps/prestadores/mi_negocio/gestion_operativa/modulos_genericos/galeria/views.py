...
class GaleriaViewSet(viewsets.ViewSet):
    """
    ViewSet para la gestión de la Galería de imágenes.
    """
    permission_classes = [IsAuthenticated, IsOwner]

    def list(self, request):
        return Response({"message": "Módulo de Galería en desarrollo."}, status=status.HTTP_200_OK)
