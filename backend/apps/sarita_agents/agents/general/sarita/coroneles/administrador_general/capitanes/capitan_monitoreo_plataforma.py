...
class CapitanMonitoreoPlataforma(CapitanTemplate):
    ...
    def plan(self, mision):
        ...
        plan_tactico = self.coronel.get_or_create_plan_tactico(
            ...
            descripcion=f"Ejecutar monitoreo para el objetivo: {mision.directiva_original.get('objective', 'N/A')}"
        )
        ...
        logger.info(f"CAPITÁN {self.__class__.__name__}: Planificación completada y tarea delegada a 'monitoreo_plataforma'.")
