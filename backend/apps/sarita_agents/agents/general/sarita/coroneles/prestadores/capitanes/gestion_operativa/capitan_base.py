...
class CapitanOperativaBase(CapitanTemplate):
    ...
    def __init__(self, coronel):
        ...
        logger.info(f"CAPITÁN CapitanOperativaBase: Inicializado para Misión ID {mision.id}.")
    ...
    def plan(self, mision):
        ...
        """
        logger.info(f"CAPITÁN CapitanOperativaBase: Planificando la misión.")
        ...
        logger.info(f"CAPITÁN CapitanOperativaBase: Planificación completada y tareas delegadas.")
