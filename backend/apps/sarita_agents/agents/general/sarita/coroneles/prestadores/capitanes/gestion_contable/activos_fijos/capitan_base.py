...
class CapitanActivosFijosBase(CapitanTemplate):
    ...
    def __init__(self, coronel):
        ...
        logger.info(f"CAPITÁN CapitanActivosFijosBase: Inicializado para Misión ID {mision.id}.")
    ...
    def plan(self, mision):
        ...
        """
        logger.info(f"CAPITÁN CapitanActivosFijosBase: Planificando la misión.")
        ...
        logger.info(f"CAPITÁN CapitanActivosFijosBase: Planificación completada y tareas delegadas.")
