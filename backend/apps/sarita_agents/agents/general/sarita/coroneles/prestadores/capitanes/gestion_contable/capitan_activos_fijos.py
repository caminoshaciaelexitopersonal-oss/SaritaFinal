...
class CapitanActivosFijos(CapitanTemplate):
    ...
    def __init__(self, coronel):
        ...
        logger.info(f"CAPITÁN CapitanActivosFijos: Inicializado para Misión ID {mision.id}.")
    ...
    def plan(self, mision):
        ...
        """
        logger.info(f"CAPITÁN CapitanActivosFijos: Planificando la misión.")
        ...
        logger.info(f"CAPITÁN CapitanActivosFijos: Planificación completada y tareas delegadas.")
