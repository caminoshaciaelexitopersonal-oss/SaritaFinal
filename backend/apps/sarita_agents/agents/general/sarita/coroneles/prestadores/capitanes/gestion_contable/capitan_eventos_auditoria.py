...
class CapitanEventosAuditoria(CapitanTemplate):
    ...
    def __init__(self, coronel):
        ...
        logger.info(f"CAPITÁN CapitanEventosAuditoria: Inicializado para Misión ID {mision.id}.")
    ...
    def plan(self, mision):
        ...
        """
        logger.info(f"CAPITÁN CapitanEventosAuditoria: Planificando la misión.")
        ...
        logger.info(f"CAPITÁN CapitanEventosAuditoria: Planificación completada y tareas delegadas.")
