...
class CapitanComercialGastronomico(CapitanTemplate):
    def _get_tenientes(self) -> dict:
        return {"activacion": "comercial_activacion"}

    def plan(self, mision):
        pasos = {"1": {"teniente": "activacion", "descripcion": "Activar comanda de restaurante.", "parametros": mision.directiva_original.get("parameters", {})}}
