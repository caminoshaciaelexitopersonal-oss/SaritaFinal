...
class CapitanComunicacionesOperativas(CapitanTemplate):
    ...
    def __init__(self, coronel):
        ...
        logger.info(f"CAPITÁN CapitanComunicacionesOperativas: Inicializado para Misión ID {mision.id}.")
    ...
    def plan(self, mision):
        ...
        """
        logger.info(f"CAPITÁN CapitanComunicacionesOperativas: Planificando la misión.")
        ...
        logger.info(f"CAPITÁN CapitanComunicacionesOperativas: Planificación completada y tareas delegadas.")
