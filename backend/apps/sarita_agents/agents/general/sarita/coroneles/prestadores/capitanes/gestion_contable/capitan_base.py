...
class CapitanContableBase(CapitanTemplate):
    ...
    def __init__(self, coronel):
        ...
        logger.info(f"CAPITÁN CapitanContableBase: Inicializado para Misión ID {mision.id}.")
    ...
    def plan(self, mision):
        ...
        """
        logger.info(f"CAPITÁN CapitanContableBase: Planificando la misión.")
        ...
        logger.info(f"CAPITÁN CapitanContableBase: Planificación completada y tareas delegadas.")
