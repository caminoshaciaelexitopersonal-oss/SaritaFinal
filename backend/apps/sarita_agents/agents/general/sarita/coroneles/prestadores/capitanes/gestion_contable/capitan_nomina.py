...
class CapitanNomina(CapitanTemplate):
    ...
    def __init__(self, coronel):
        ...
        logger.info(f"CAPITÁN CapitanNomina: Inicializado para Misión ID {mision.id}.")
    ...
    def plan(self, mision):
        ...
        """
        logger.info(f"CAPITÁN CapitanNomina: Planificando la misión.")
        ...
        logger.info(f"CAPITÁN CapitanNomina: Planificación completada y tareas delegadas.")
