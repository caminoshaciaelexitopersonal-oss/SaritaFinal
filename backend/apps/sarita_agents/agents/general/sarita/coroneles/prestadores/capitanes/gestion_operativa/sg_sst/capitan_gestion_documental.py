...
class CapitanGestionDocumental(CapitanTemplate):
    ...
    def __init__(self, coronel):
        ...
        logger.info(f"CAPITÁN CapitanGestionDocumental: Inicializado para Misión ID {mision.id}.")
    ...
    def plan(self, mision):
        ...
        """
        logger.info(f"CAPITÁN CapitanGestionDocumental: Planificando la misión.")
        ...
        logger.info(f"CAPITÁN CapitanGestionDocumental: Planificación completada y tareas delegadas.")
