...
class CapitanComercialBase(CapitanTemplate):
    ...
    def __init__(self, coronel):
        ...
        logger.info(f"CAPITÁN CapitanComercialBase: Inicializado para Misión ID {mision.id}.")
    ...
    def plan(self, mision):
        ...
        """
        logger.info(f"CAPITÁN CapitanComercialBase: Planificando la misión.")
        ...
        logger.info(f"CAPITÁN CapitanComercialBase: Planificación completada y tareas delegadas.")
