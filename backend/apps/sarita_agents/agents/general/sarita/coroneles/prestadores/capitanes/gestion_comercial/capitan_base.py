...
class CapitanComercialBase(CapitanTemplate):
    ...
    def __init__(self, mision_id: str, objective: str, parametros: Dict[str, Any]):
        ...
        self.logger.info(f"CAPITÁN CapitanComercialBase: Inicializado para Misión ID {self.mision_id}.")
    ...
    def plan(self):
        ...
        """
        self.logger.info(f"CAPITÁN CapitanComercialBase: Planificando la misión.")
        ...
        self.logger.info(f"CAPITÁN CapitanComercialBase: Planificación completada y tareas delegadas.")
