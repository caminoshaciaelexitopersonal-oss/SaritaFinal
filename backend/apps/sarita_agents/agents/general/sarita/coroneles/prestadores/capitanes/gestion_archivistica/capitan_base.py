...
class CapitanArchivisticaBase(CapitanTemplate):
    ...
    def __init__(self, coronel):
        ...
        logger.info(f"CAPITÁN CapitanArchivisticaBase: Inicializado para Misión ID {mision.id}.")
    ...
    def plan(self, mision):
        ...
        """
        logger.info(f"CAPITÁN CapitanArchivisticaBase: Planificando la misión.")
        ...
        logger.info(f"CAPITÁN CapitanArchivisticaBase: Planificación completada y tareas delegadas.")
