...
class CapitanNominaBase(CapitanTemplate):
    ...
    def __init__(self, coronel):
        ...
        logger.info(f"CAPITÁN CapitanNominaBase: Inicializado para Misión ID {mision.id}.")
    ...
    def plan(self, mision):
        ...
        """
        logger.info(f"CAPITÁN CapitanNominaBase: Planificando la misión.")
        ...
        logger.info(f"CAPITÁN CapitanNominaBase: Planificación completada y tareas delegadas.")
