...
class CapitanDepreciacionContable(CapitanTemplate):
    ...
    def __init__(self, coronel):
        ...
        logger.info(f"CAPITÁN CapitanDepreciacionContable: Inicializado para Misión ID {mision.id}.")
    ...
    def plan(self, mision):
        ...
        """
        logger.info(f"CAPITÁN CapitanDepreciacionContable: Planificando la misión.")
        ...
        logger.info(f"CAPITÁN CapitanDepreciacionContable: Planificación completada y tareas delegadas.")
