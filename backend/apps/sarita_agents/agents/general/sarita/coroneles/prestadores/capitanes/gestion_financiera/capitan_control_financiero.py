...
class CapitanControlFinanciero(CapitanTemplate):
    ...
    def __init__(self, coronel):
        ...
        logger.info(f"CAPITÁN CapitanControlFinanciero: Inicializado para Misión ID {mision.id}.")
    ...
    def plan(self, mision):
        ...
        """
        logger.info(f"CAPITÁN CapitanControlFinanciero: Planificando la misión.")
        ...
        logger.info(f"CAPITÁN CapitanControlFinanciero: Planificación completada y tareas delegadas.")
