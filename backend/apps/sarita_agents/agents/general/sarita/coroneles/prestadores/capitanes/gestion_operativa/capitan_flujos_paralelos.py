...
class CapitanFlujosParalelos(CapitanTemplate):
    def _get_tenientes(self) -> dict:
        return {"ejecucion": "admin_persistencia_operativa"}

    def plan(self, mision):
        pasos = {"1": {"teniente": "ejecucion", "descripcion": "Ejecutar paso paralelo A.", "parametros": mision.directiva_original.get("parameters", {})}}
