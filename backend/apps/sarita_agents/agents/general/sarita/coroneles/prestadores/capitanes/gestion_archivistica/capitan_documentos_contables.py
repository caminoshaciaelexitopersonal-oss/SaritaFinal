...
class CapitanDocumentosContables(CapitanTemplate):
    def _get_tenientes(self) -> dict:
        return {"archivado": "archivistico_archivado"}

    def plan(self, mision):
        pasos = {"1": {"teniente": "archivado", "descripcion": "Archivar documento contable.", "parametros": mision.directiva_original.get("parameters", {})}}
