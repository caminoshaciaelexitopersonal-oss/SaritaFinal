...
class CapitanCostosYRentabilidad(CapitanTemplate):
    ...
    def __init__(self, coronel):
        ...
        logger.info(f"CAPITÁN CapitanCostosYRentabilidad: Inicializado para Misión ID {mision.id}.")
    ...
    def plan(self, mision):
        ...
        """
        logger.info(f"CAPITÁN CapitanCostosYRentabilidad: Planificando la misión.")
        ...
        logger.info(f"CAPITÁN CapitanCostosYRentabilidad: Planificación completada y tareas delegadas.")
