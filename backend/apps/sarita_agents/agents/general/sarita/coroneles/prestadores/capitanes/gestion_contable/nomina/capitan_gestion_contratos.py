...
class CapitanGestionContratos(CapitanTemplate):
    ...
    def __init__(self, coronel):
        ...
        logger.info(f"CAPITÁN CapitanGestionContratos: Inicializado para Misión ID {mision.id}.")
    ...
    def plan(self, mision):
        ...
        """
        logger.info(f"CAPITÁN CapitanGestionContratos: Planificando la misión.")
        ...
        logger.info(f"CAPITÁN CapitanGestionContratos: Planificación completada y tareas delegadas.")
