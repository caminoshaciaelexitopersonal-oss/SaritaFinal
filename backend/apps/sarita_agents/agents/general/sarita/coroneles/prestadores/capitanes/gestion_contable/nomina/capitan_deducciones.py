...
class CapitanDeducciones(CapitanTemplate):
    ...
    def __init__(self, coronel):
        ...
        logger.info(f"CAPITÁN CapitanDeducciones: Inicializado para Misión ID {mision.id}.")
    ...
    def plan(self, mision):
        ...
        """
        logger.info(f"CAPITÁN CapitanDeducciones: Planificando la misión.")
        ...
        logger.info(f"CAPITÁN CapitanDeducciones: Planificación completada y tareas delegadas.")
