...
class CapitanComercialTuristicoTours(CapitanTemplate):
    def _get_tenientes(self) -> dict:
        return {"activacion": "comercial_activacion"}

    def plan(self, mision):
        pasos = {"1": {"teniente": "activacion", "descripcion": "Activar reserva de tour.", "parametros": mision.directiva_original.get("parameters", {})}}
