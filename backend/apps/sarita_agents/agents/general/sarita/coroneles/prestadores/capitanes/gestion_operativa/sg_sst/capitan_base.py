...
class CapitanSGSSTBase(CapitanTemplate):
    ...
    def __init__(self, coronel):
        ...
        logger.info(f"CAPITÁN CapitanSGSSTBase: Inicializado para Misión ID {mision.id}.")
    ...
    def plan(self, mision):
        ...
        """
        logger.info(f"CAPITÁN CapitanSGSSTBase: Planificando la misión.")
        ...
        logger.info(f"CAPITÁN CapitanSGSSTBase: Planificación completada y tareas delegadas.")
