...
class CapitanIntegracionMonedero(CapitanTemplate):
    def _get_tenientes(self) -> dict:
        return {"registro": "contable_registro"}

    def plan(self, mision):
        pasos = {"1": {"teniente": "registro", "descripcion": "Registrar entrada de efectivo desde Monedero Virtual.", "parametros": mision.directiva_original.get("parameters", {})}}
