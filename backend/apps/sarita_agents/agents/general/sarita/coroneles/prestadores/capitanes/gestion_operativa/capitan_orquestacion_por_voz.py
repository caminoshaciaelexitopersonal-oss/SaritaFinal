...
class CapitanOrquestacionPorVoz(CapitanTemplate):
    ...
    def __init__(self, coronel):
        ...
        logger.info(f"CAPITÁN CapitanOrquestacionPorVoz: Inicializado para Misión ID {mision.id}.")
    ...
    def plan(self, mision):
        ...
        """
        logger.info(f"CAPITÁN CapitanOrquestacionPorVoz: Planificando la misión.")
        ...
        logger.info(f"CAPITÁN CapitanOrquestacionPorVoz: Planificación completada y tareas delegadas.")
