...
class CapitanReportesYCertificados(CapitanTemplate):
    ...
    def __init__(self, coronel):
        ...
        logger.info(f"CAPITÁN CapitanReportesYCertificados: Inicializado para Misión ID {mision.id}.")
    ...
    def plan(self, mision):
        ...
        """
        logger.info(f"CAPITÁN CapitanReportesYCertificados: Planificando la misión.")
        ...
        logger.info(f"CAPITÁN CapitanReportesYCertificados: Planificación completada y tareas delegadas.")
