...
class CapitanSaludOcupacional(CapitanTemplate):
    ...
    def __init__(self, coronel):
        ...
        logger.info(f"CAPITÁN CapitanSaludOcupacional: Inicializado para Misión ID {mision.id}.")
    ...
    def plan(self, mision):
        ...
        """
        logger.info(f"CAPITÁN CapitanSaludOcupacional: Planificando la misión.")
        ...
        logger.info(f"CAPITÁN CapitanSaludOcupacional: Planificación completada y tareas delegadas.")
