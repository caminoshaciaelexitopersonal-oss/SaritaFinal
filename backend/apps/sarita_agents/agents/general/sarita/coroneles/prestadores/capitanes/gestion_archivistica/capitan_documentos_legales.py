...
class CapitanDocumentosLegales(CapitanTemplate):
    def _get_tenientes(self) -> dict:
        return {"archivado": "archivistico_archivado"}

    def plan(self, mision):
        pasos = {"1": {"teniente": "archivado", "descripcion": "Archivar documento legal.", "parametros": mision.directiva_original.get("parameters", {})}}
