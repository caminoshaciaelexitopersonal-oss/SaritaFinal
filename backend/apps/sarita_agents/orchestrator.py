...
class SaritaOrchestrator:
    ...
    def __init__(self):
        ...
        self.coroneles = {
            ...
            "operativo_turistico": CoronelOperativaTuristica(general=self),
            # Aliases para retrocompatibilidad de dominios
            "operativo_hospedaje": CoronelOperativaTuristica(general=self),
            "operativo_gastronomia": CoronelOperativaTuristica(general=self),
            "operativo_transporte": CoronelOperativaTuristica(general=self),
            "operativo_nocturno": CoronelOperativaTuristica(general=self),
            "operativo_guias": CoronelOperativaTuristica(general=self),
            "operativo_agencia": CoronelOperativaTuristica(general=self),
            "operativo_artesano": CoronelOperativaTuristica(general=self),
