...
from .agents.general.sarita.coroneles.operativo_especializado.artesanos.coronel import CoronelOperativoArtesanos
...
class SaritaOrchestrator:
    ...
    def __init__(self):
        ...
        self.coroneles = {
            ...
            "operativo_artesano": CoronelOperativoArtesanos(general=self),
