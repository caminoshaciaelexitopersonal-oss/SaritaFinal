// frontend/src/app/dashboard/(authenticated)/prestador/mi-negocio/gestion-comercial/facturas-proveedor/[id]/components/RegistrarPagoRealizadoForm.tsx
'use client';
...
export default function RegistrarPagoRealizadoForm({ onSubmit, isLoading }: RegistrarPagoFormProps) {
