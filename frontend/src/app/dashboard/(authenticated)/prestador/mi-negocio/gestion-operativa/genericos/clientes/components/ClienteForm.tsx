// frontend/src/app/dashboard/(authenticated)/prestador/mi-negocio/gestion-operativa/genericos/clientes/components/ClienteForm.tsx
'use client';
...
export default function ClienteForm({ onSubmit, initialData, isLoading }: ClienteFormProps) {
  const { register, handleSubmit, reset, formState: { errors } } = useForm<Omit<Cliente, 'id'>>();
