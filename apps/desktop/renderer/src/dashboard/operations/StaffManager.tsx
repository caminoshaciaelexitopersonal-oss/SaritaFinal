  ...
  useEffect(() => {
    const fetchStaff = async () => {
      try {
        ...
        setStaff([
          { id: '1', name: 'Andrés Villamil', role: 'Guía Principal', status: 'En campo', rating: 4.9 },
          { id: '2', name: 'Laura Espitia', role: 'Operador Logístico', status: 'Disponible', rating: 4.8 },
          { id: '3', name: 'Carlos Rodríguez', role: 'Conductor Safari', status: 'Libre', rating: 4.7 },
        ]);
      }
    };
    fetchStaff();
