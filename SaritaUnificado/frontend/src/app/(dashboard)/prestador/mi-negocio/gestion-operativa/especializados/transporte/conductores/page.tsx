...
const GestionConductoresPage = () => {
    const { data: conductores, loading, error, createItem, updateItem, deleteItem } = useApi('transporte/conductores/');
    ...
    const handleSave = async (e) => {
        ...
        const data = {
            ...
            licencia_conduccion: formData.get('licencia_conduccion'),
            vencimiento_licencia: formData.get('vencimiento_licencia'),
        };
