  ...
  return (
    <div>
      ...
      <Modal
        isOpen={isModalOpen}
        onClose={closeModal}
        title={editingRecurso ? 'Editar Recurso' : 'Nuevo Recurso'}
      >
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          <div>
            <label htmlFor="tipo_recurso" className="block text-sm font-medium text-gray-700">
              Tipo de Recurso
            </label>
            <select
              id="tipo_recurso"
            ...
            {recursos.map((recurso) => (
              <tr key={recurso.id}>
                ...
                <td className="py-2 px-4 border-b">
                  <button
                    onClick={() => openModalForEdit(recurso)}
