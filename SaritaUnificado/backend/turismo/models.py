...
class Reserva(models.Model):
    ...
    cliente = models.ForeignKey(CustomUser, on_delete=models.SET_NULL, null=True, blank=True, related_name='reservas_hechas')
    nombre_cliente_externo = models.CharField(max_length=200, blank=True, help_text="Nombre del cliente si no es un usuario registrado")
