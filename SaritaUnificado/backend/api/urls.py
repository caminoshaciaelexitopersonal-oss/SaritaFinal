...
# --- Panel del Prestador (Anidado) ---
router.register(r'prestador/servicios', views.ServicioTuristicoViewSet, basename='prestador-servicio')
router.register(r'prestador/reservas', views.BookingViewSet, basename='prestador-booking')
router.register(r'prestador/facturas', views.FacturaViewSet, basename='prestador-factura')
