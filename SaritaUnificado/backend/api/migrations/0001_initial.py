...
class Migration(migrations.Migration):
    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        related_name="turistas_depto_origen",
                        to="api.departamento",
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    api.fields.EncryptedTextField(
                        blank=True,
                        help_text="Clave de API para el proveedor Groq.",
                        null=True,
                ...
                (
                    ...
                    api.fields.EncryptedTextField(
                        blank=True,
                        help_text="Clave de API para el proveedor OpenAI.",
                        null=True,
                ...
                (
                    ...
                    api.fields.EncryptedTextField(
                        blank=True,
                        help_text="Clave de API para el proveedor Google (Gemini).",
                        null=True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="bookings_realizadas",
                        to=settings.AUTH_USER_MODEL,
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            name="DireccionMunicipalDeTurismo",
            fields=[
                (
                    "id",
                    models.BigAutoField(
                ...
                (
                    "municipio",
                    models.OneToOneField(
                        on_delete=django.db.models.deletion.CASCADE, to="api.municipio"
                    ),
                ),
            ],
        ),
        migrations.CreateModel(
            name="DireccionDepartamentalDeTurismo",
            fields=[
                (
                    "id",
                    models.BigAutoField(
                ...
                (
                    "dependencias_municipales",
                    models.ManyToManyField(
                        blank=True, to="api.direccionmunicipaldeturismo"
                    ),
                ),
            ],
        ),
        ...
        migrations.AddField(
            model_name="inventariotipoitem",
            name="empresa",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="api.prestadorservicio"
            ),
        ),
        migrations.CreateModel(
            name="ImagenGaleria",
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                null=True,
                on_delete=django.db.models.deletion.SET_NULL,
                related_name="empleados_customuser",
                to="api.prestadorservicio",
            ),
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            ...
            name="recurso",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.PROTECT, to="api.recursoreservable"
            ),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "disponibilidad",
                    models.TextField(
                        blank=True, help_text="Ej: 'Lunes a Viernes de 9am a 5pm'"
                    ),
                ),
                (
                    "prestador",
