...
# STATICFILES_DIRS se deja vacío ya que el frontend Next.js gestionará sus propios estáticos.
STATICFILES_DIRS = []
...
REST_AUTH = {
    ...
    "USE_JWT": True,
    "JWT_AUTH_COOKIE": "sarita-auth-token",
    "JWT_AUTH_REFRESH_COOKIE": "sarita-refresh-token",
    "TOKEN_MODEL": None,
}
