...
CREATE OR REPLACE FUNCTION ai_core.fn_trg_context_guard()
RETURNS TRIGGER AS $$
BEGIN
...
BEFORE INSERT OR UPDATE ON ai_core.agent_context_universal
FOR EACH ROW EXECUTE FUNCTION ai_core.fn_trg_context_guard();
