...
def deploy():
    ...
    phases = [
        ...
        ['30_mi_negocio', '31_gestion_comercial', '32_gestion_operativa', '33_operativa_especializada', '34_gestion_archivistica', '35_gestion_contable', '36_gestion_financiera', '37_analitica_financiera', '40_facturacion', '41_costos'], # ERP
    ...
    print("--- Iniciando Despliegue ERP MI NEGOCIO (Fase 10.4) ---")
    ...
    print(f"Registrando versión v10.4_erp_full (Checksum: {final_checksum[:10]})")
    subprocess.run(['psql', db_url, '-c', f"SELECT core.apply_schema_version('v10.4_erp_full', '{final_checksum}')"], check=True)
