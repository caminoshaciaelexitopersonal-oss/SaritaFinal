...
def deploy():
    ...
    phases = [
        ...
        ['35_gestion_contable/01_catalogos', '35_gestion_contable/02_configuracion', '35_gestion_contable/03_movimientos', '35_gestion_contable/04_periodos', '35_gestion_contable/05_impuestos', '35_gestion_contable/06_conciliacion', '35_gestion_contable/07_analitica', '35_gestion_contable/08_auditoria'], # ACCOUNTING
        ['36_gestion_financiera', '37_analitica_financiera', '40_facturacion', '41_costos'],
    ...
    print("--- Iniciando Despliegue MOTOR CONTABLE REAL (Fase 10.8) ---")
    ...
    print(f"Registrando versión v10.8_real_accounting_mapping (Checksum: {final_checksum[:10]})")
    subprocess.run(['psql', db_url, '-c', f"SELECT core.apply_schema_version('v10.8_real_accounting_mapping', '{final_checksum}')"], check=True)

    print("--- DESPLIEGUE CONTABLE COMPLETADO ---")
