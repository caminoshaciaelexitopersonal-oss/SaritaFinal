...
INSERT INTO ai_core.agents_master (id, agent_name, hierarchy_level, specialization, domain_scope)
VALUES ('11111111-1111-1111-1111-111111111111', 'SARITA_GUARDIAN', 1, 'GLOBAL_OBSERVER', '{GLOBAL}');

-- 2. Creación de Contexto
INSERT INTO ai_core.agent_context_universal (id, tenant_id, domain, entity_type, entity_id, trace_id)
...
INSERT INTO ai_core.agent_executions (id, agent_id, context_id, execution_type, tenant_id, trace_id, execution_status)
...
INSERT INTO ai_core.agent_memory_global (context_id, agent_id, memory_scope, content, tenant_id)
...
INSERT INTO ai_core.agent_decisions (agent_id, context_id, decision_type, approved, tenant_id, trace_id)
...
-- INSERT INTO ai_core.agent_executions (agent_id, context_id, execution_type) VALUES (...); -- Esto lanzará excepción
