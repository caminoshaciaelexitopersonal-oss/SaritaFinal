...
CREATE OR REPLACE FUNCTION ai_core.fn_ai_suspend_user(p_user_id UUID, p_reason TEXT)
RETURNS VOID AS $$
BEGIN
...
CREATE OR REPLACE FUNCTION ai_core.fn_ai_freeze_wallet(p_wallet_id UUID, p_reason TEXT)
RETURNS VOID AS $$
BEGIN
