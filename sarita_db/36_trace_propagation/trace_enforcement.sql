...
DROP TRIGGER IF EXISTS trg_trace_enforcement ON ledger.transactions;
CREATE TRIGGER trg_trace_enforcement BEFORE INSERT ON ledger.transactions FOR EACH ROW EXECUTE FUNCTION core.enforce_trace_id();

DROP TRIGGER IF EXISTS trg_trace_enforcement ON payments.payment_intents;
CREATE TRIGGER trg_trace_enforcement BEFORE INSERT ON payments.payment_intents FOR EACH ROW EXECUTE FUNCTION core.enforce_trace_id();
