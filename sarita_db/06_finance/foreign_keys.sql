...
-- [LEDGER & WALLET]
ALTER TABLE finance.ledger_entries ADD CONSTRAINT fk_le_trans FOREIGN KEY (transaction_id) REFERENCES finance.transactions(id);
ALTER TABLE finance.ledger_entries ADD CONSTRAINT fk_le_acc FOREIGN KEY (account_id) REFERENCES finance.accounts(id);

-- [PAYMENTS]
ALTER TABLE finance.payment_intents ADD CONSTRAINT fk_pi_provider FOREIGN KEY (payment_provider_id) REFERENCES finance.payment_providers(id);
...
ALTER TABLE ai_core.agent_hierarchy ADD CONSTRAINT fk_ah_parent FOREIGN KEY (parent_agent_id) REFERENCES ai_core.agents_master(id);
ALTER TABLE ai_core.agent_hierarchy ADD CONSTRAINT fk_ah_child FOREIGN KEY (child_agent_id) REFERENCES ai_core.agents_master(id);
...
ALTER TABLE ai_core.agent_actions ADD CONSTRAINT fk_aa_execution FOREIGN KEY (execution_id) REFERENCES ai_core.agent_executions(id);
ALTER TABLE ai_core.agent_memory_global ADD CONSTRAINT fk_amg_context FOREIGN KEY (context_id) REFERENCES ai_core.agent_context_universal(id);
ALTER TABLE ai_core.agent_memory_global ADD CONSTRAINT fk_amg_agent FOREIGN KEY (agent_id) REFERENCES ai_core.agents_master(id);
ALTER TABLE ai_core.agent_learning ADD CONSTRAINT fk_al_agent FOREIGN KEY (agent_id) REFERENCES ai_core.agents_master(id);
ALTER TABLE ai_core.agent_learning ADD CONSTRAINT fk_al_context FOREIGN KEY (context_id) REFERENCES ai_core.agent_context_universal(id);
ALTER TABLE ai_core.agent_decisions ADD CONSTRAINT fk_ad_agent FOREIGN KEY (agent_id) REFERENCES ai_core.agents_master(id);
ALTER TABLE ai_core.agent_decisions ADD CONSTRAINT fk_ad_context FOREIGN KEY (context_id) REFERENCES ai_core.agent_context_universal(id);
